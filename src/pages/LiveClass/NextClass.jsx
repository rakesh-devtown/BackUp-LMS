    ...
    <StyledBox width={width} leftPadding={leftPadding}>
      <div className="content">
        ...
        <div className="content-bottom">
          ...
          <Link to={"/video"}>
            <Button type="primary" size="large" danger disabled={disabled} style={{ height: "47px" }}>
              Watch Live
            </Button>
          </Link>
        </div>
...
const StyledBox = styled.div`
  padding-left: ${(props) => (props.width >= 768 && props.leftPadding ? "70px" : 0)};
  width: 100%;
  .content-top {
    color: white;
    font-size: 16px;
