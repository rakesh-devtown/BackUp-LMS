...
const LiveClass = () => {
  ...
  const handleScheduleModal = () => setIsModalOpen(!isModalOpen);
    ...
    <Layout style={{ height: "100%" }}>
      ...
      <Content style={{ background: "#F4F7FE", height: "100%" }}>
        <StyledModal
          ...
          styles={{ header: { padding: "24px", background: "#F5F7FE" } }}
          maskClosable
          width={400}
        ...
        <MainContainer width={width} rightSidebarWidth={rightSidebarWidth}>
          ...
          <ModuleBody>
            ...
            {currentCourseDetails &&
              currentCourseDetails?.sections?.map((ele, ind) => <ModuleChapter section={ele} index={ind} />)}
          </ModuleBody>
