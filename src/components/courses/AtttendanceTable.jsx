            ...
            render: (partialPresence, row) => (
              partialPresence && (
                <div
                  ...
                  data-tooltip-content={row.duration < row.sessionDuration * 0.7 ? "You were present for less than 70% of the session" : "You were present for less than 30 minutes in the meeting"}
