  ...
  return (
    <Layout className="layout">
        ...
        <StyledLoginPage>
            ...
            <StyledLoginForm>
              ...
              <Form name="login-form" onFinish={onFinish}>             
                  <Form.Item name="form-text"  >
                    <StyledP>Login to your account to get back to your learning.</StyledP>                  
                  </Form.Item>
                {/* Username input */}
          ...
          <StyledImg  src="https://www.student-platform.devtown.in/static/media/Login_image.d23150f57543b9b841d955f9245b17ca.svg"
              alt="Login"/>
