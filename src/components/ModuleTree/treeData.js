...
export const treeData = [
  ...
  },
  {
    ...
    children: [
      {
        title: (
          <ModuleCard title={"Module 1: Introduction to HTML"} locked={true} />
        ),
        key: "2-1",
        checkable: false,
        selectable: false,
      ...
      {
        title: (
          <ModuleCard title={"Module 2: Introduction to HTML"} locked={true} />
        ),
        key: "2-2",
        checkable: false,
        selectable: false,
      ...
      {
        title: (
          <ModuleCard title={"Module 3: Introduction to HTML"} locked={true} />
        ),
        key: "2-3",
        checkable: false,
        // selectable: false,
    ...
    children: [
      {
        ...
        children: [
          {
            title: <TopicCard time={"07:31"} topic={"Topic 1"} lock={true} />,
            key: "5-1-1",
            className: "level-3",
          },
          {
